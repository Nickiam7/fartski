...
Fart.prototype.play = function(sound, callback) {
	...
	if (!this.fart_old_player) {
		...
		this.fart_player.setAttribute('src', "https://www.jsfart.com/farts/" + fart + ext);
		...
		this.fart_player.URL = "https://www.jsfart.com/farts/" + fart + '.mp3';
	}
};
...
Fart.prototype.preload = function() {
	...
	if (!this.fart_old_player && !Fart.preloaded) {
		for(f in farts){
			...
			fart_player.setAttribute('src', "https://www.jsfart.com/farts/" + farts[f] + ext);
